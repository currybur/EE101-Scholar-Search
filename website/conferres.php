...
$sql1 = "select ConferenceID from conferences
		 where ConferenceName like '%".$name."%'";
...
$sql2 = "select ConferenceName,ConferenceID from conferences
		 where ConferenceName like '%".$name."%'
		 order by ConferenceID desc limit $startPage,$pageSize";
...
while($row2 = mysql_fetch_array($result2))
  ...
  echo "<tr><td><a href='new_3.php?new1=".$row2["ConferenceID"]."&new2=".$row2["ConferenceName"]."'>".$row2["ConferenceName"]."</a></td><td>".$row2["ConferenceID"]."</td></tr>";
  /*$arr['list'][] = array(
  'id' => $row2['AuthorID'], 
