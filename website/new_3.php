...
$(function(){
	$("#next").click(function(){
		...
		$.ajax({
			type:'POST',
		    url:"conference.php",
			data:{'pageNum':pageNum,'name':conid},
...
<div class="demon">	
	<div class="bt"><a href="https://en.wikipedia.org/wiki/<?php echo $nn?>"><?php echo $nn?></a></div>
